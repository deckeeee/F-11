...
import org.F11.scada.server.logging.parser.BarGraph2LoggingState;
 ...
 */
public class BarGraph2LoggingHandler extends AbstractLoggingHandler {
	private BarGraph2ValueListHandlerManager handlerManager;

	/**
	 * SAXハンドラクラスを生成します。
	 */
	public BarGraph2LoggingHandler(
	...
	public void startElement(
		...
		if (name.equals("logging")) {
			stack.push(new BarGraph2LoggingState(handlerManager, this));
		} else {
