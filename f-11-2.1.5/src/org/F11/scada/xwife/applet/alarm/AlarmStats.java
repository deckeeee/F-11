...
public class AlarmStats extends JLabel implements TableModelListener {
	...
	public AlarmStats() {
		super();
		alarmNewsConfig =  new AlarmDefine().getAlarmConfig().getAlarmNewsConfig();
	...
	public void tableChanged(TableModelEvent e) {
		...
		for (int i = 13; i < model.getColumnCount() - 1; i++) {
			sb.append(model.getValueAt(0, i) + "　");
		}
		setText(sb.toString());
		setForeground(ColorFactory.getColor((String) model.getValueAt(0, 3)));
	}
