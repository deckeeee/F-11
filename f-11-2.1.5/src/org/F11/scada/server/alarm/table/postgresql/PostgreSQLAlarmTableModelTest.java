...
public class PostgreSQLAlarmTableModelTest extends TestCase {
	static final String[] careerTitle = {
		...
		"point", "provider", "holder", "サウンドパス", "Emailグループ", "Emailモード",
		"日時", "記号", "名称", "警報・状態"
	};
	...
	protected void setUp() throws Exception {
		...
		careerData = new Object[]{
			"JP", Boolean.TRUE, new Integer(0), "RED",
			new Integer(0), "P1", "D_1900000_Digital", "SoundPath", "EMailGroup", new Integer(3),
			createTime, "AHU 1-1-1", "空調機ファン", "停止"
		};
	}
	...
	public void testPostgreSQLAlarmTableModel() {
		try {
			PostgreSQLAlarmTableModel.createDefaultAlarmTableModel(null, createTitleMap());
			fail();
	...
	public void testGetAlarmJournalCareer() {
		DataValueChangeEventKey evt = CreateEvent.create(dp, "D_1900000_Digital");
		...
		AlarmTableJournal jn2 = AlarmTableJournal.createRowDataAddOpe(evt, careerData);
	...
	public void testSetValueAt() {
		...
		Object[] newData = new Object[]{
			"JP", Boolean.TRUE, new Integer(0), "GREEN",
			new Integer(0), "P1", "D_1900000_Digital", "", "", new Integer(0),
			ts, "AHU 1-1-1", "空調機ファン", "停止"
		};
	...
	public void testInsertRow() {
		...
		careerModel.insertRow(0, careerData, CreateEvent.create(dp, "D_1900000_Digital", createTime));
		assertEquals("JP", careerModel.getValueAt(0, "ジャンプパス"));
		assertEquals(Boolean.TRUE, careerModel.getValueAt(0, "自動ジャンプ"));
		assertEquals(new Integer(0), careerModel.getValueAt(0, "優先順位"));
		assertEquals("RED" ,careerModel.getValueAt(0, "表示色"));
	...
	public void testRemoveRow() {
		careerModel.insertRow(0, careerData, CreateEvent.create(dp, "D_1900000_Digital"));
...
//		assertEquals(createTime, aj.getTimestamp());
	...
	public void testSetValue() {
		...
		careerModel.setValueAt(newData, 0, 3, CreateEvent.create(dp, "D_1900000_Digital"));
		careerModel.removeRow(0, CreateEvent.create(dp, "D_1900000_Digital"));

		SortedMap ajsMap = careerModel.getAlarmJournal(0);
		assertEquals(3, ajsMap.size());

		AlarmTableModel model = PostgreSQLAlarmTableModel
	...
	public void testCheckEvent() throws Exception {
		...
		careerModel.fireCheckEvent(new CheckEvent(
		...
		careerModel.fireCheckEvent(new CheckEvent(
				AlarmDataProvider.NONCHECK,
				new TestTableModel(Boolean.TRUE, "P3", "H10", new Timestamp(2000), new Integer(3)),
				0,
				new Timestamp(1000)));
	...
	private static class CreateEvent {
		...
		static DataValueChangeEventKey create(DataProvider dp, String holder, Timestamp time) {
			DataHolder dh = dp.getDataHolder(holder);
			dh.setParameter(WifeDataProvider.PARA_NAME_POINT, new Integer(0));
