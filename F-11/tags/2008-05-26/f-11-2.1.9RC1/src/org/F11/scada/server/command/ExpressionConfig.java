 ...
 */
public class ExpressionConfig implements ClassConfigContainer {
	/** Expressionの評価式文字列です */
	...
	public boolean isEnableInitialMode() {
		return isEnableInitialMode;
	}

	public void setEnableInitialMode(boolean isEnableInitialMode) {
