 ...
 */
public class SelectiveLoggingState implements State {
	SelectiveValueListHandlerManager handlerManager;
	private static Logger logger;
	private SelectiveLoggingHandler handler;

	/**
	 * 状態を表すオブジェクトを生成します。
	 */
	public SelectiveLoggingState(
			SelectiveValueListHandlerManager handlerManager,
			SelectiveLoggingHandler handler) {
	...
	public void add(String tagName, Attributes atts, Stack stack) {
		...
		if (tagName.equals("task")) {
			stack.push(new SelectiveTaskState(tagName, atts, this));
		} else {
