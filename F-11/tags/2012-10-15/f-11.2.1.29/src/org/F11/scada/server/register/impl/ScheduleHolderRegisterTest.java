...
/**
 * ScheduleHolderRegisterのテストケース
 * @author Hideaki Maekawa <frdm@users.sourceforge.jp>
 */
public class ScheduleHolderRegisterTest extends TestCase {
    ...
    /**
     * Constructor for ScheduleHolderRegisterTest.
     * @param arg0
     */
    public ScheduleHolderRegisterTest(String arg0) {
        super(arg0);
    }

    public void testRegister() {
    	ScheduleHolderRegister hr = new ScheduleHolderRegister();
    	hr.setOwner(new ScheduleHolderOwner() {
        ...
        assertTrue(dh.getValue() instanceof WifeDataSchedule);
        hr.unregister(item);
