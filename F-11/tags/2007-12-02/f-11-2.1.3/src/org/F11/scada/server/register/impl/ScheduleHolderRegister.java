 ...
 */
public class ScheduleHolderRegister extends AbstractHolderRegister {
	private ScheduleHolderOwner owner;

    public void setOwner(ScheduleHolderOwner owner) {
		this.owner = owner;
	}
    ...
    public void register(Item item) {
		...
		owner.putScheduleHolder(item.getPoint(), dh);
    }
}
