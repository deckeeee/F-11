...
/**
 * 警報確認イベントのジャーナルを転送するサーバーコマンドです
 * @author maekawa
 *
 */
public class GetCheckEventJournal implements InvokeHandler {

	public Object invoke(Object[] args) {
		String provider = (String) args[0];
		String holder = (String) args[1];
		Long t = (Long) args[2];
		DataHolder dh = Manager.getInstance().findDataHolder(provider, holder);
		AlarmTableModel model = (AlarmTableModel) dh.getValue();
		return model.getCheckJournal(t.longValue());
	}
}
