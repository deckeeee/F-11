...
/**
 * 日報印刷に使用するデータソースを生成する処理クラスです
 * @author Hideaki Maekawa <frdm@users.sourceforge.jp>
 */
public class DailyPrintDataSource
	...
	/**
	 * 日報データの開始日を現在の日時より算出します。
	 * @return 日報データの開始日を現在の日時より算出します。
	 */
	...
	/**
	 * 日報データの終了日を現在の日時より算出します。
	 * @return 日報データの終了日を現在の日時より算出します。
	 */
