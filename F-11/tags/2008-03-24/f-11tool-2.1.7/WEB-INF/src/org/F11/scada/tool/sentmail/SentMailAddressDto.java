...
public class SentMailAddressDto implements Serializable {
	private static final long serialVersionUID = 6554102911271157252L;
	...
	public String toString() {
		return "alarmEmailSentAddressesId=" + alarmEmailSentAddressesId
			+ ", alarmEmailSentId=" + alarmEmailSentId
			+ ", address=" + address;
	}
}
