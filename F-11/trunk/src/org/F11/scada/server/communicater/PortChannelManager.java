...
/**
 * セレクタ及びポートを管理する為のクラスです。 ポートへのリスナー追加、削除は必ずこのオブジェクトを介して行います。 シングルトン
 */
public final class PortChannelManager {
	...
	/**
	 * ポートを取得し、リスナーを登録します。 ポートが登録されていない場合は新たにポートを開き、セレクタに登録します。 セレクタが無い場合は作成します。
	...
	/**
	 * リスナーを削除します。 ポートのリスナーが全て削除された場合に、ポートを閉じてセレクタから消去します。
	...
	/*
	 * ポートを取得します。 ポートが登録されていない場合は新たにポートを開き、セレクタに登録します。 セレクタが無い場合は作成します。
	 */
