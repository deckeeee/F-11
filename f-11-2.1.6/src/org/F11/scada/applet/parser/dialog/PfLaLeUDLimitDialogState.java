...
import org.F11.scada.applet.dialog.PfUDLimitDialog;
 ...
 */
public class PfLaLeUDLimitDialogState implements State {
	 ...
	 * @param 親の状態オブジェクト
	 */
	public PfLaLeUDLimitDialogState(
		String tagName,
		Attributes atts,
		DialogMapState state) {
		this.state = state;
