...
/**
 * Analog4HolderRegisterのテストケース
 * @author Hideaki Maekawa <frdm@users.sourceforge.jp>
 */
public class Analog4HolderRegisterTest extends TestCase {
    ...
    /**
     * Constructor for Analog4HolderRegisterTest.
     * @param arg0
     */
    public Analog4HolderRegisterTest(String arg0) {
        super(arg0);
    }

    public void testRegister() {
        HolderRegister hr = new Analog4HolderRegister();
        Item item = new Item();
        item.setDataType(18);
        ...
        assertTrue(dh.getValue() instanceof WifeDataAnalog4);
        hr.unregister(item);
        assertNotNull(dp);
        assertSame(dp, manager.getDataProvider("P1")); 
        dh = dp.getDataHolder("Test01");
        assertNull(dh);
    }
