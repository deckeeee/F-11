 ...
 * @author hori
 */
public class LifeCheckState implements State {
	 ...
	 * 
	 */
	public LifeCheckState(String tagName, Attributes atts, TimeSetTaskState state) {
		...
		if (dh == null)
			throw new NullPointerException(
				"dataholder is null ["
					...
					+ holder
					+ "]");
		state.lifeCheckHolders.add(provider + '_' + holder);
	}
