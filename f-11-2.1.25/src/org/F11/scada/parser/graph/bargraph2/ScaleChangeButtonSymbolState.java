...
public class ScaleChangeButtonSymbolState implements State {
	private static Logger logger = Logger.getLogger(ScaleChangeButtonSymbolState.class);
	 ...
	 * 
	 */
	public ScaleChangeButtonSymbolState(String tagName, Attributes atts,
			VerticallyScaleModel vartical) {
	...
	public void end(String tagName, Stack stack) {
		...
		if (tagName.equals("scalechangebutton")) {
			vartical.addScaleChangeButtonSymbol(button);
			stack.pop();
		} else {
