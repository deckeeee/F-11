 ...
 */
public class TextPowerfactorSymbolEditable extends TextAnalogSymbol implements
		TenkeyEditable {
	private static final long serialVersionUID = 2326838923641650606L;
	private final Logger logger = Logger.getLogger(TextPowerfactorSymbolEditable.class);
	/** ダイアログ表示位置 */
	 ...
	 */
	public TextPowerfactorSymbolEditable(
	 ...
	 * @param property SymbolProperty オブジェクト
	 */
	public TextPowerfactorSymbolEditable(SymbolProperty property) {
		super(property);
		addMouseListener();
		actions = new ArrayList();
