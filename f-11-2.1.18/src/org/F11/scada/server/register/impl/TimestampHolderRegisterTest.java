...
/**
 * TimestampHolderRegisterのテストケース
 * @author Hideaki Maekawa <frdm@users.sourceforge.jp>
 */
public class TimestampHolderRegisterTest extends TestCase {
    ...
    /**
     * Constructor for TimestampHolderRegisterTest.
     * @param arg0
     */
    public TimestampHolderRegisterTest(String arg0) {
        super(arg0);
    }

    public void testRegister() {
        HolderRegister hr = new TimestampHolderRegister();
        Item item = new Item();
        item.setDataType(17);
        ...
        assertTrue(dh.getValue() instanceof WifeDataTimestamp);
        hr.unregister(item);
